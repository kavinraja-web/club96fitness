      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto mb-16 bg-slate-50 border border-slate-200/80 rounded-3xl p-6 sm:p-8 shadow-md flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-5">
            {/* Star Rating Badge */}
            <div className="w-16 h-16 rounded-2xl bg-amber-500/10 text-amber-500 shadow-sm flex items-center justify-center border border-amber-200 flex-shrink-0">
          ...
          <a
            ...
            className="px-6 py-3.5 bg-white hover:bg-slate-100 text-slate-800 font-bold text-sm rounded-xl border border-slate-300 shadow-sm transition-colors whitespace-nowrap flex items-center gap-2 cursor-pointer touch-manipulation"
          >
                ...
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-4">
                      {/* Clean Typography Initials Badge */}
                      <div className="w-12 h-12 rounded-full bg-red-600/10 text-red-600 font-extrabold text-base flex items-center justify-center border border-red-200 shadow-inner">
                        {initials}
                      </div>
                      <div>
